...
module.exports = {
  ...
  // chore: Внутренние изменения, обновления или исправления, которые не влияют на функциональность продукта (например, обновление зависимостей, настройка среды разработки).
  // localization: Локализация или переводы.
  // cleanup: Удаление неиспользуемого кода, файлов или ресурсов.
  // merge: Слияние изменений из одной ветки в другую.
  // release: Создание новой версии продукта или публикация релиза.
  // config: Изменения в конфигурационных файлах или параметрах.
  // migrate: Миграция данных или изменение схемы базы данных.
  // security: Исправление уязвимостей или улучшение безопасности.
  // chore: Различные обычные задачи и обслуживание проекта.
